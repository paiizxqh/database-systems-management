...
<?php foreach($price_list as $priceList)
{
    ...
    <td><a href=?controller=priceLists&action=updateForm
    &PriceListID=$priceList->ID>update</a></td>
    <td><a href=?controller=priceLists&action=deleteConfirm
    &PriceListID=$priceList->ID>delete</a></td>
    </tr>";
}
echo "</table>";
?>
